...
namespace NodeCanvas.Tasks.Actions {
	...
	public class RepairAT : ActionTask {
		...
		protected override void OnUpdate() {
			...
			float activeTreshold =lightTowerBlackboard.GetVariableValue<float>("activeThreshold");
			if (currentRepairValue > activeTreshold)
			{

			}
				//until it reaches an activethresholdvlaue
		}
